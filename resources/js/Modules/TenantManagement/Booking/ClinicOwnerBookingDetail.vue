    ...
    >
        <div class="space-y-8">
            ...
            >
                    ...
                    <dl class="mt-4 grid gap-4 text-sm">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-slate-950">
                                {{ booking.patientEmail || t('bookingDetail.notProvided') }}
                            </dd>
                        </div>
                        <div>
                            <dt class="font-semibold text-slate-500">
                                {{ t('bookingDetail.notes') }}
                            </dt>
                            <dd class="mt-1 whitespace-pre-wrap text-slate-950">
                                {{ booking.notes || t('bookingDetail.notProvided') }}
                            </dd>
                        </div>
                    </dl>
                </article>
                ...
                <article class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
                    <h2 class="text-lg font-bold text-slate-950">
                        {{ t('bookingDetail.bookingSnapshot') }}
                    </h2>
                    <dl class="mt-4 grid gap-4 text-sm sm:grid-cols-2">
                        <div>
                            <dt class="font-semibold text-slate-500">
                                {{ t('bookingDetail.service') }}
                            </dt>
                            <dd class="mt-1 text-slate-950">
                                {{ booking.serviceName || t('bookingDetail.notSelected') }}
                            </dd>
                        </div>
                        <div>
                            <dt class="font-semibold text-slate-500">
                                {{ t('bookingDetail.source') }}
                            </dt>
                            <dd class="mt-1 text-slate-950">{{ booking.sourceLabel }}</dd>
                        </div>
                        <div>
                            <dt class="font-semibold text-slate-500">
                                {{ t('bookingDetail.localSchedule') }}
                            </dt>
                            <dd class="mt-1 text-slate-950">
                        ...
                        <div>
                            <dt class="font-semibold text-slate-500">
                                {{ t('bookingDetail.timezone') }}
                            </dt>
                            <dd class="mt-1 text-slate-950">{{ booking.timezone }}</dd>
                        </div>
                        <div>
                            <dt class="font-semibold text-slate-500">
                                {{ t('bookingDetail.utcSnapshot') }}
                            </dt>
            ...
            <section aria-labelledby="booking-history-title">
                <h2 id="booking-history-title" class="text-xl font-bold text-slate-950">
                    {{ t('bookingDetail.bookingHistory') }}
                </h2>
                    ...
                    >
                        <div class="flex flex-wrap items-start justify-between gap-3">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-slate-600">
                                    {{ t('bookingDetail.actor') }}: {{ entry.actorLabel }}
                        ...
                        >
                            <div v-for="(value, key) in entry.payload" :key="key">
                                ...
                                <dd class="mt-1 break-words text-slate-950">
                                    {{ value === null ? t('bookingDetail.notProvided') : value }}
                                </dd>
                            </div>
                        </dl>
                    </li>
                ...
                <DashboardEmptyState
                    v-else
                    :title="t('bookingDetail.noBookingHistory')"
                    :description="t('bookingDetail.noBookingHistoryDescription')"
                />
            </section>
        </div>
    </DashboardShell>
