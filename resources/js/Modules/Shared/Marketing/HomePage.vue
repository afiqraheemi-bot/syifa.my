...
const copy = {
    ms: {
        ...
        hero: {
            eyebrow: 'DIBINA KHAS UNTUK KLINIK MALAYSIA',
            title: 'Lebih mudah ditemui.',
            titleAccent: 'Lebih mudah ditempah.',
            body: 'Website profesional dan sistem tempahan dalam satu platform terurus. Kami uruskan bahagian digital klinik anda—supaya pasukan anda boleh terus fokus kepada pesakit.',
            primaryCta: 'Bina Website Klinik',
            secondaryCta: 'Lihat Cara Ia Berfungsi',
            trustNote: 'Setup percuma · Tiada kemahiran teknikal diperlukan',
            benefits: ['Website premium', 'Tempahan 24/7', 'Sokongan tempatan'],
        },
        trustBar: {
    ...
    en: {
        ...
        hero: {
            eyebrow: 'PURPOSE-BUILT FOR MALAYSIAN CLINICS',
            title: 'Easier to discover.',
            titleAccent: 'Easier to book.',
            body: 'A professional website and booking system in one managed platform. We take care of your clinic’s digital presence—so your team can stay focused on patients.',
            primaryCta: 'Build My Clinic Website',
            secondaryCta: 'See How It Works',
            trustNote: 'Free setup · No technical skills required',
            benefits: ['Premium website', '24/7 booking', 'Local support'],
        },
        trustBar: {
