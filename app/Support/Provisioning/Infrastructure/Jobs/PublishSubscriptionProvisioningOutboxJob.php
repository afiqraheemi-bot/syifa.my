...
final class PublishSubscriptionProvisioningOutboxJob implements ShouldQueue
{
    use Dispatchable, InteractsWithQueue, Queueable, SerializesModels;

    public function handle(PublishSubscriptionProvisioningOutboxService $publisher): void
    {
