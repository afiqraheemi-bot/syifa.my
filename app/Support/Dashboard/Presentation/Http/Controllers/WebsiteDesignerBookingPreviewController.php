...
final readonly class WebsiteDesignerBookingPreviewController
{
    public function __invoke(
        ...
        if ($request->isMethod('post')) {
            return $this->submit($request, $booking, $submissionTokens, $tenantId, $jobId);
        }
        ...
        return view('public-website.booking.preview', [
            ...
            'backUrl' => route('dashboard.onboarding.preview', $jobId),
        ]);
    }
    ...
    private function submit(
        ...
        try {
            ...
            Log::error('Unexpected Website Designer booking preview submission failure.', [
