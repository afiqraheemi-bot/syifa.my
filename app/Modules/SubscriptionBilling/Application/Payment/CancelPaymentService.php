...
final readonly class CancelPaymentService
{
    ...
    public function execute(PaymentTransitionCommand $command): PaymentData
    {
        ...
        $payment->cancel($command->occurredAt);
        $this->payments->save($payment);
        $this->audit->record('payment.cancel', $payment, $command->occurredAt, $command->correlationId);
