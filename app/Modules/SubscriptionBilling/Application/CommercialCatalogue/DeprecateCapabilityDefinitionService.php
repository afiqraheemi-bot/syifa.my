 ...
 */
final readonly class DeprecateCapabilityDefinitionService
{
    private const string AUDIT_ACTION = 'commercial_catalogue.capability_definition.deprecate';
    ...
    public function execute(DeprecateCapabilityDefinitionCommand $command): CapabilityDefinition
    {
        ...
        $updated = $capabilityDefinition->deprecate();
