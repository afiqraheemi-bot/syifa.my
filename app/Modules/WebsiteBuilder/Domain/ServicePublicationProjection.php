...
final readonly class ServicePublicationProjection
{
    public function __construct(public string $serviceId, public string $displayName, public ?string $shortDescription)
    {
        if (preg_match('/^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i', $serviceId) !== 1
            ...
            throw new InvalidWebsiteValueException('Service publication projection is invalid.');
        }
    }
}
