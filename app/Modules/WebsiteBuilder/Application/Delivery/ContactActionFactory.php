...
{
    public function make(FooterRenderModel $contact): ContactActionSet
    {
        ...
        $whatsApp = $contact->whatsAppNumber === null ? null : new PublicUrl('https://wa.me/'.rawurlencode(ltrim($contact->whatsAppNumber, '+')));
        $directions = null;
