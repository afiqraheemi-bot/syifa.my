...
final readonly class CancelClinicRegistrationService
{
    ...
    public function execute(CancelClinicRegistrationCommand $command): ClinicRegistrationData
    {
        ...
        $registration->cancel($command->occurredAt);
        $this->registrations->save($registration);
        $this->audit->record('clinic_registration.cancel', $registration, $command->occurredAt, $command->correlationId);
