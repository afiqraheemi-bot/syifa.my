...
final class SubscriptionFoundationArchitectureTest extends TestCase
{
    ...
    public function test_foundation_introduces_no_transport_persistence_or_payment_artifact(): void
    {
        ...
        self::assertSame([
            ...
            $this->root().'/database/migrations/subscription_billing/2026_08_15_100001_backfill_standard_blog_capability.php',
            $this->root().'/database/migrations/subscription_billing/2026_08_15_100002_backfill_legacy_standard_blog_capability.php',
