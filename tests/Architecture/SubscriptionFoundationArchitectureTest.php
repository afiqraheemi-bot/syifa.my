...
final class SubscriptionFoundationArchitectureTest extends TestCase
{
    ...
    public function test_foundation_introduces_no_transport_persistence_or_payment_artifact(): void
    {
        ...
        self::assertSame([
            ...
            $this->root().'/database/migrations/subscription_billing/2026_07_24_000001_add_authoritative_verification_to_webhook_receipts.php',
            $this->root().'/database/migrations/subscription_billing/2026_07_24_000002_index_payment_attempt_provider_reference.php',
            ...
            $this->root().'/database/migrations/subscription_billing/2026_08_15_000001_allow_zero_value_trial_payments.php',
            $this->root().'/database/migrations/subscription_billing/2026_08_15_100001_backfill_pro_blog_capability.php',
            $this->root().'/database/migrations/subscription_billing/2026_08_15_100002_backfill_pro_blog_capability_by_features.php',
            ...
            $this->root().'/database/migrations/subscription_billing/2026_10_03_000001_repair_official_subscription_entitlements.php',
            $this->root().'/database/migrations/subscription_billing/2026_10_05_000001_allow_exhausted_activation_result_code.php',
    ...
    public function test_foundation_contains_only_domain_and_approved_test_artifacts(): void
    {
        ...
        self::assertSame([], array_values(array_filter(
            ...
            static fn (string $file): bool => ! str_contains($file, '/Infrastructure/Persistence/')
                ...
                && ! str_contains($file, '/Infrastructure/Entitlements/PostgresSubscriptionEntitlementLookup.php')
