...
final class PlatformAdministrationSessionAuthenticationArchitectureTest extends TestCase
{
    public function test_session_authentication_surface_exists_only_in_the_platform_administration_namespaces(): void
    {
        ...
        foreach ([
            ...
            $root.'/Application/Authentication/PlatformMfaChallengeService.php',
            $root.'/Application/Authentication/PlatformPrincipalResolver.php',
            $root.'/Contracts/Authentication/PendingPlatformAuthenticationData.php',
            $root.'/Contracts/Authentication/PendingPlatformAuthenticationStoreInterface.php',
            $root.'/Contracts/Authentication/PlatformMfaChallengeData.php',
            $root.'/Contracts/Authentication/PlatformMfaChallengeInterface.php',
            $root.'/Contracts/Authentication/PlatformMfaEnrollmentData.php',
            $root.'/Contracts/Authentication/PlatformMfaEnrollmentRepositoryInterface.php',
            ...
            $root.'/Infrastructure/Session/LaravelPendingPlatformAuthenticationStore.php',
            $root.'/Infrastructure/Session/LaravelPlatformSessionStore.php',
            $root.'/Presentation/Http/Controllers/PlatformEmailVerificationController.php',
            $root.'/Presentation/Http/Controllers/PlatformPasswordConfirmationController.php',
            $root.'/Presentation/Http/Controllers/PlatformPasswordResetController.php',
            ...
            $root.'/Presentation/Http/Requests/PlatformConfirmPasswordRequest.php',
            $root.'/Presentation/Http/Requests/PlatformForgotPasswordRequest.php',
            $root.'/Presentation/Http/Requests/PlatformMfaChallengeRequest.php',
            $root.'/Presentation/Http/Requests/PlatformResetPasswordRequest.php',
