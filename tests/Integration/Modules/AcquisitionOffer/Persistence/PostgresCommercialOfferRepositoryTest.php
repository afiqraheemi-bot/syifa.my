...
namespace Tests\Integration\Modules\AcquisitionOffer\Persistence;
...
final class PostgresCommercialOfferRepositoryTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $migration = require base_path('database/migrations/acquisition_offer/2026_07_21_000001_create_commercial_offer_tables.php');
        self::assertInstanceOf(Migration::class, $migration);
        $this->migration = $migration;
        $migration->up();

        $tenantIdMigration = require base_path('database/migrations/acquisition_offer/2026_07_26_000001_add_tenant_id_to_commercial_offers.php');
        self::assertInstanceOf(Migration::class, $tenantIdMigration);
        $this->tenantIdMigration = $tenantIdMigration;
        $tenantIdMigration->up();

        $provenanceMigration = require base_path('database/migrations/acquisition_offer/2026_07_30_000001_add_renewal_offer_provenance.php');
        ...
        $ownershipMigration = require base_path('database/migrations/acquisition_offer/2026_08_28_000001_correct_initial_commercial_offer_ownership.php');
