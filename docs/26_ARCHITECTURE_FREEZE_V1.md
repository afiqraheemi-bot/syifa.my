...
- **2026-07-22:** ADR-013 accepted Phase 1 Service-level collision-safe Booking reservation, Clinic-local availability ownership, mandatory Service and duration, authoritative PostgreSQL overlap enforcement, the four-state lifecycle, authorization/audit rules, the public-exposure guardrail, and the separate Increment 5C–5H implementation sequence.
