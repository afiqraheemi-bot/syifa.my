...
> **Public Website Rendering Contract amendment (2026-08-14):** Public rendering is a deterministic transient projection of immutable Published Snapshots into typed Website, Branding, SEO, Header, Footer, Section, Asset, and Publication contracts. This foundation adds no HTML, Blade, Vue, route, controller, API, cache, or storage resolution.

> **Website Published Section Content Snapshot amendment (2026-08-13):** Website publication captures normalized immutable typed content and renderability evidence for all nine governed Sections. Public delivery can therefore remain independent from mutable draft, Clinic, Service, Booking, and storage configuration. This increment adds no renderer, HTML, controller, API, preview, or deployment capability.
